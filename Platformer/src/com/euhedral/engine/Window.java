...
public class Window extends Canvas {
    ...
    // Creates a JFrame window for the game with the given width and height. The string title is used as the window's title.
    ...
    public Window(int width, int height, String title, Engine engine) {
        ...
        System.out.println("com.Window created");
        ...
        frame.add(engine);
        System.out.println("com.Engine added to window");
